(function (marked) {
    ...
    */
    ...
    async function handleHttpStatus(response) {
    	...
    	if (!(errorMessage in debounceFlashMessage)) {
    		debounceFlashMessage[errorMessage] = debounce$1(() => m.show({
    			type: 'error',
    ...
    */
    ...
    const _hoisted_2$h = /*#__PURE__*/createBaseVNode("label", {
      for: "password",
    ...
    const _hoisted_5$a = { class: "d-flex gap-3 mt-3 mt-sm-0" };
        ...
        createVNode(_component_VForm, {
          ...
          default: withCtx(({ errors }) => [
            ...
            createBaseVNode("div", _hoisted_3$f, [
              ...
              }, toDisplayString($setup.submitLabel), 9 /* TEXT, PROPS */, _hoisted_4$e),
    ...
    const _hoisted_4$b = { class: "context" };
    const _hoisted_5$8 = { class: "card-header d-flex align-items-center" };
    ...
    const _hoisted_5$6 = /*#__PURE__*/createBaseVNode("label", {
      for: "password_plain",
      class: "form-label"
    }, "Password", -1 /* HOISTED */);
            ...
            default: withCtx(({ errors }) => [
              ...
              createBaseVNode("div", _hoisted_3$6, [
                createBaseVNode("button", {
                  ...
                  disabled: $setup.sending,
                  class: "btn btn-primary gradient float-end"
                }, toDisplayString($setup.submitLabel), 9 /* TEXT, PROPS */, _hoisted_4$6)
              ])
            ]),
            _: 1 /* STABLE */
          }, 8 /* PROPS */, ["onSubmit"]))
    ...
    const _hoisted_2$7 = { class: "card shadow" };
      ...
      return (openBlock(), createElementBlock("div", _hoisted_1$9, [
        createBaseVNode("div", {
          ...
          createBaseVNode("ul", null, [
            (openBlock(true), createElementBlock(Fragment, null, renderList($setup.articles, (article) => {
              return (openBlock(), createElementBlock("li", {
                key: article.id
              }, [
                createVNode(_component_router_link, {
                  to: { name: "article-open", params: { id: article.id } }
                }, {
                  default: withCtx(() => [
                    createTextVNode(toDisplayString(article.title), 1 /* TEXT */)
                  ]),
                  _: 2 /* DYNAMIC */
    ...
    function render$9(_ctx, _cache, $props, $setup, $data, $options) {
      ...
      return (openBlock(), createElementBlock("div", null, [
          ...
          default: withCtx(({ errors }) => [
            createBaseVNode("div", null, [
              ...
              createVNode(_component_VField, {
                ...
                label: "tag",
                "aria-label": "tag",
                class: normalizeClass(["form-control", { "is-invalid": errors.tags }])
              }, null, 8 /* PROPS */, ["modelValue", "class"]),
              createVNode(_component_ErrorMessage, {
                name: "tag",
                class: "invalid-feedback shake"
        ...
        createBaseVNode("ul", null, [
          (openBlock(true), createElementBlock(Fragment, null, renderList($setup.chosenTags, (tag) => {
            return (openBlock(), createElementBlock("li", { key: tag }, toDisplayString(tag), 1 /* TEXT */))
          }), 128 /* KEYED_FRAGMENT */))
        ])
      ]))
    }
    ...
    script$7.__file = "src/views/Article.vue";
    ...
    const _hoisted_1$5 = { class: "container mt-5" };
      ...
      return (openBlock(), createElementBlock("div", _hoisted_1$5, [
        createBaseVNode("div", {
          ...
          createBaseVNode("div", _hoisted_2$3, [
            createBaseVNode("h1", _hoisted_3$3, toDisplayString($props.title), 1 /* TEXT */)
          ]),
          createBaseVNode("div", _hoisted_4$3, [
            createBaseVNode("p", _hoisted_5$3, toDisplayString($props.message), 1 /* TEXT */)
          ])
        ], 2 /* CLASS */)
      ]))
    }
    ...
    script$6.__file = "src/views/Error.vue";
    ...
    const needLogin = to => store.state.loggeduser ? true : { name: 'login', query: { redirect: to.fullPath } };

    const needAdmin = to => store.state.loggeduser.isadmin ? true : error(to);
    ...
    const router$1 = createRouter({
    	routes: [
    		...
    		//] },
    		{ path: '/:pathMatch(.*)*', component: script$6, name: 'error', props: true },
    	],
    ...
    const _hoisted_2 = /*#__PURE__*/createBaseVNode("img", {
      src: "/public/assets/uusilogo04_nobg.png",
      alt: ""
    }, null, -1 /* HOISTED */);
    const _hoisted_3 = { class: "navbar-nav" };
    const _hoisted_4 = /*#__PURE__*/createTextVNode("HKI Book");
    const _hoisted_5 = { class: "nav-item dropdown" };
    const _hoisted_6 = /*#__PURE__*/createBaseVNode("button", {
      id: "usermenu",
      class: "nav-link btn btn-unstyled fs-2 rounded-circle",
    ...
    const _hoisted_10 = /*#__PURE__*/createTextVNode("Profile");
    const _hoisted_11 = { key: 2 };
    const _hoisted_12 = { key: 3 };
    const _hoisted_13 = /*#__PURE__*/createTextVNode("Log in");

    function render$1(_ctx, _cache, $props, $setup, $data, $options) {
      const _component_router_link = resolveComponent("router-link");

      return (openBlock(), createElementBlock("nav", {
        class: normalizeClass(["navbar navbar-expand-sm shadow mb-4 mb-md-5", $setup.colorScheme.navbar])
      }, [
        createBaseVNode("div", _hoisted_1$1, [
          createVNode(_component_router_link, {
            to: { name: "home" },
            class: "navbar-brand hki-logo py-0"
          }, {
            default: withCtx(() => [
              _hoisted_2
            ]),
    ...
    const app = createApp(script)
    	//.use(store)
    	.use(router$1)
    	.use(api$1, {storeApi: store, routerApi: router$1})
    	.use(c)
    	.use(modal)
    	//app.provide('colorScheme', colorScheme)
