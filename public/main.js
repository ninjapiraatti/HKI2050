(function () {
    ...
    */
    ...
    const _hoisted_3$b = /*#__PURE__*/createBaseVNode("label", {
      for: "email",
      class: "form-label"
    }, "Email", -1 /* HOISTED */);
    ...
    const _hoisted_2$5 = /*#__PURE__*/createBaseVNode("div", { class: "card-header" }, [
    ...
    const _hoisted_2$3 = { class: "card shadow" };
    ...
    const _hoisted_2$2 = { class: "row gx-4" };
    const _hoisted_3$2 = { class: "col" };
    const _hoisted_4$2 = { class: "counter" };
    const _hoisted_5$2 = /*#__PURE__*/createBaseVNode("div", { class: "bigasslogo" }, [
    ...
    const _hoisted_4 = { class: "nav-item dropdown" };
